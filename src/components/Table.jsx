...
const PeriodicTable = ({ jsonData }) => {
  ...
  return (
    <div ref={vantaRef} className="min-h-screen p-4 relative">
      
      <button
        className="fixed top-4 left-4 z-[70] text-white text-3xl hover:text-gray-300 transition-colors duration-200"
      ...
      <div
        className={`relative max-w-7xl mx-auto z-10 transition-all duration-300 ${
          selectedElement ? "blur-sm" : ""
        }`}>

        <h1 className="text-white text-4xl font-bold font-serif text-center mb-6">
          Periodic Table
        </h1>

        <div
          className="grid gap-1 mb-8 justify-center mt-2"
          style={{
        ...
        <div className="mt-10 text-white text-center font-semibold">
            <a href="https://nikhil-keshri2213.github.io/MyPortfolio/"
            target="_blank"
      ...
      {selectedElement && (
        <div className="fixed inset-0 flex items-center justify-center z-[60]">
          <div 
            ...
            onClick={() => setSelectedElement(null)}></div>
